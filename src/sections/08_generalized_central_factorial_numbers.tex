\begin{definition}[Generalized central factorial numbers of the second kind]
  \label{def:generalized-central-factorial-numbers}
...
For example, for $T_0(n,k)$ we have
...
For example, for $T_4(n,k)$ we have
\input{sections/tables/01_fig_oeis_central_factorial_numbers_2n_2k.tex}

Thus, yields the formula for sums of powers in terms of

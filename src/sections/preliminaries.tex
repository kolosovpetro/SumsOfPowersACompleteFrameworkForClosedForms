  ...
  \begin{proof}
    \begin{enumerate}
      ...
      \item Let $r=3$, then we have
        ...
        = \binom{n+2}{3}$.
      \item Similarly, for arbitrary $r$, by hockey stick identity
...
\input{sections/formulas/06_oeis_central_factorial_numbers.tex}

\input{sections/formulas/07_example_sums_of_squares_cfn.tex}

\input{sections/formulas/08_example_sums_of_cubes_cfn.tex}

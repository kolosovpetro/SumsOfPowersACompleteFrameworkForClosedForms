\begin{lemma}[Central Newton's formula]
  ...
  \label{lem:centra-newtons-formula}
  \begin{align*}
    f(x)
...
\begin{lemma}[Newton's formula for powers decomposition]
  \label{lem:central-newtons-formula-for-powers-decomposition}
  For integers $n,m \geq 0$, and an arbitrary integer $t$,
  \begin{align*}
...
\begin{convention} For all $x$
  ...
  \end{align*}
\end{convention}
Donald Knuth give extensive discussion on why the convention $0^x=1$ have to hold for
all $x$ in Concrete Mathematics~\cite[~p. 162]{graham1994concrete},

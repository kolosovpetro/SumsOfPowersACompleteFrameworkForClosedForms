...
we can omit odd iterations of $k$
\begin{align*}
...
\end{align*}
By applying Lemma~\eqref{lem:central-factorials-binomial-form}, we get
\begin{align*}
  n^{2m}
...
\begin{align*}
  \KnuthRFoldSum{1}{n}{2m-1} = \sum_{k=1}^{m} (2k-1)! \binom{n+k}{2k} T(2m,2k),
\end{align*}
which matches the Proposition~\eqref{prop:knuth-odd-powers-sum} precisely.
